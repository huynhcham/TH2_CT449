...
exports.create = async (req, res, next) => {
    if (!req.body?.name){
        return next(new ApiError(400, "Name can not be emptry"));
    }
    try{
...
exports.update = async (req, res, next)=>{
    if (Object.keys(req.body).length == 0){
        return next(new ApiError(404, "Data to update can not be emptry"));
    }
    try{
        const contactService = new ContactService(MongoDB.client);
...
exports.delete = async (req, res, next)=>{
    try{
        ...
        return res.send({message: "Contact was deteled successfully"});
...
exports.deleteALL = async (req, res, next)=>{
    try{
        ...
        return res.send({message: `${deletedCount} Contact was deteled successfully`});
